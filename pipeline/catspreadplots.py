...
# Incomplete scans
#incscans = ['9.5', '14.9', '79.7', '90.5', 

incscans = ['91.4', '103.1', '104.0', '122.9', '127.4', '223.7', '273.2', '283.1', '289.4', '306.5', '309.2', '324.5', '329.9', '338.0', '339.8', '342.5', '343.4', '345.2', '348.8', '349.7', '350.6', '351.5', '352.4', '353.3', '354.2', '355.1', '356.0', '357.8']
...
for curregion in skyrange:
    ...
    plt.tight_layout()
    plt.savefig('region'+curregion+'matchplots.png')
    #plt.show()
    plt.close()
