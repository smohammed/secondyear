...
axes[1, 1].scatter(rcp['TEFF'], rcp['LOGG'], c=rcp['FE_H'], vmin=-0.5, vmax=0.35, s=1, alpha=0.5)
axes[0, 1].set_xlim(4200, 5400)
axes[1, 1].set_xlim(4200, 5400)
...
fig, axes = plt.subplots(2, 2)
axes[0, 0].hist(rcp['LOGG'], bins=20, range=[1, 3])
axes[1, 0].hist(rcg['LOGG'], bins=20, range=[1, 3])
cmap = axes[0, 1].scatter(np.log10(rcp['TEFF']), rcp['LOGG'], c=rcp['FE_H'], vmin=-0.5, vmax=0.35, s=1, alpha=0.1)
