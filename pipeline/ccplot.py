...
ax1.arrow(extx, exty, extdx, extdy, head_length=0.1,color='red')
ax2.arrow(extx, exty, extdx, extdy, head_length=0.1,color='red')
ax3.arrow(extx, exty, extdx, extdy, head_length=0.1,color='red')
ax4.arrow(extx, exty, extdx, extdy, head_length=0.1,color='red')
