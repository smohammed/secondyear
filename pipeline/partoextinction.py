...
if cat == 1:
    ...
    for i in range(0, len(sg), 5000):
        print i
        sgcut = sg[i:i+5000]
        sggl = sgcut['gl_gps'].tolist()
        sggb = sgcut['gb_gps'].tolist()
    ...
    cols = fits.ColDefs([fits.Column(name='nuv_mag', format='D', array=sg['nuv_mag']), fits.Column(name='gl_gps', format='D', array=sg['gl_gps']), fits.Column(name='gb_gps', format='D', array=sg['gb_gps']), fits.Column(name='ra_gps', format='D', array=sg['ra_gps']), fits.Column(name='dec_gps', format='D', array=sg['dec_gps']), fits.Column(name='phot_g_mean_mag', format='D', array=sg['phot_g_mean_mag']), fits.Column(name='gl_tgas', format='D', array=sg['gl_tgas']), fits.Column(name='gb_tgas', format='D', array=sg['gb_tgas']), fits.Column(name='parallax', format='D', array=sg['parallax']), fits.Column(name='parallax_error', format='D', array=sg['parallax_error']), fits.Column(name='dist', format='D', array=pc), fits.Column(name='distmod', format='D', array=distmod), fits.Column(name='MG', format='D', array=Mg), fits.Column(name='ebv', format='D', array=ebv), fits.Column(name='parallax_hogg', format='D', array=parallax)])

    endtable = fits.BinTableHDU.from_columns(cols)
    endtable.writeto('../galexplane_tgas_dust_interp.fits')
