...
#axes[1, 1].scatter((c1['nuv_mag']-c1['ebv']*7.76)-(c1['phot_g_mean_mag']-c1['ebv']*3.303), c1['MNUV']-c1['ebv']*3.303, s=40, edgecolor='none', label='APO', c=c1[cbarax], vmin=vmin, vmax=vmax)
cbar = axes[1, 1].scatter((c2['nuv_mag']-c2['ebv']*7.76)-(c2['phot_g_mean_mag']-c2['ebv']*3.303), c2['Mg']-c2['ebv']*3.303, s=40, edgecolor='none', label='Bovy', c=c2[cbarax], vmin=vmin, vmax=vmax)
...
#axes[0, 1].scatter(c1['nuv_mag']-c1['phot_g_mean_mag'], c1['MNUV'], s=40, edgecolor='none', label='APO', c=c1[cbarax], vmin=vmin, vmax=vmax)
axes[0, 1].scatter(c2['nuv_mag']-c2['phot_g_mean_mag'], c2['Mg'], s=40, edgecolor='none', label='Bovy', c=c2[cbarax], vmin=vmin, vmax=vmax)
...
#axes[1, 0].scatter((c1['B_AB']-c1['ebv']*3.626)-(c1['V_AB']-c1['ebv']*2.742), c1['MV']-c1['ebv']*2.742, s=40, edgecolor='none', label='APO', c=c1[cbarax], vmin=vmin, vmax=vmax)
axes[1, 0].scatter((c2['B_AB']-c2['ebv']*3.626)-(c2['V_AB']-c2['ebv']*2.742), c2['MV']-c2['ebv']*2.742, s=40, edgecolor='none', label='APO', c=c2[cbarax], vmin=vmin, vmax=vmax)
