...
for j in range(len(pickles)):
    ax1.annotate(pickles['name'][j][:-4],xy=(pickles[x1[1]][j]-pickles[x2[1]][j],pickles[y1[1]][j]-pickles[y2[1]][j]),size=12)
    ax2.annotate(pickles['name'][j][:-4],xy=(pickles[x1[1]][j]-pickles[x2[1]][j],pickles[y1[1]][j]-pickles[y2[1]][j]),size=12)
    ax3.annotate(pickles['name'][j][:-4],xy=(pickles[x1[1]][j]-pickles[x2[1]][j],pickles[y1[1]][j]-pickles[y2[1]][j]),size=12)
    ax4.annotate(pickles['name'][j][:-4],xy=(pickles[x1[1]][j]-pickles[x2[1]][j],pickles[y1[1]][j]-pickles[y2[1]][j]),size=12) 
# SExtractor
...
ax1.quiver(extx, exty, extdx, extdy)
ax2.quiver(extx, exty, extdx, extdy)
ax3.quiver(extx, exty, extdx, extdy)
ax4.quiver(extx, exty, extdx, extdy)
