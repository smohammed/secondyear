...
nuvfiltsum = np.sum(nuvfilt['col2'] / nuvfilt['col1']) * 3631 * 10**-23 * c_light
bfiltsum = np.sum(bfilt['col2'] / bfilt['col1']) * 3631 * 10**-23 * c_light
vfiltsum = np.sum(vfilt['col2'] / vfilt['col1']) * 3631 * 10**-23 * c_light
jfiltsum = np.sum(jfilt['col2'])  # / jfilt['col1']) * 3631 * 10**-23 * c_light
hfiltsum = np.sum(hfilt['col2'])  # / hfilt['col1']) * 3631 * 10**-23 * c_light
kfiltsum = np.sum(kfilt['col2'])  # / kfilt['col1']) * 3631 * 10**-23 * c_light
ufiltsum = np.sum(ufilt['col2'] / ufilt['col1']) * 3631 * 10**-23 * c_light
gfiltsum = np.sum(gfilt['col2'] / gfilt['col1']) * 3631 * 10**-23 * c_light
rfiltsum = np.sum(rfilt['col2'] / rfilt['col1']) * 3631 * 10**-23 * c_light
ifiltsum = np.sum(ifilt['col2'] / ifilt['col1']) * 3631 * 10**-23 * c_light
