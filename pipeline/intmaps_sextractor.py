...
for currregion in skyrange:
    ...
    # Run sextractor
    #########################################################################
    os.system('sex ../Dunmaps/im1_'+region+'.fits -c ~/sextractor/daofind.sex -CATALOG_NAME ../Dunmaps/sex_im1_'+region+'.fits -CHECKIMAGE_NAME ../Dunmaps/background_im1_'+region+filt+'.fits')
    ...
    ascii.write(alldata, '../Dunmaps/starcat_'+currregion+filt+'.txt', format='ipac')
