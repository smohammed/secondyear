...
for i in range(len(files1)):
    if float(files1[i].split('_')[3])/10. < glrange:
        gllim = i

for line in range(1):#len(files1[:gllim])):                         # Iterate through scst files
    print line
...
hdu.writeto('../5-13-aspcorr_new_scst_12000_0to20_test.fits')
