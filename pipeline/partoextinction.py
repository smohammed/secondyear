...
#################################################################
if cat == 1:
    sg = fits.open('../sex_gaia-09-14.fits')[1].data
    ...
    cols = fits.ColDefs([fits.Column(name='nuv_mag', format='D', array=sg['nuv_mag']), fits.Column(name='gl_sex', format='D', array=sg['gl_sex']), fits.Column(name='gb_sex', format='D', array=sg['gb_sex']), fits.Column(name='ra_sex', format='D', array=sg['ra_sex']), fits.Column(name='dec_sex', format='D', array=sg['dec_sex']), fits.Column(name='phot_g_mean_mag', format='D', array=sg['phot_g_mean_mag']), fits.Column(name='gl_gaia', format='D', array=sg['gl_gaia']), fits.Column(name='gb_gaia', format='D', array=sg['gb_gaia']), fits.Column(name='parallax', format='D', array=sg['parallax']), fits.Column(name='parallax_error', format='D', array=sg['parallax_error']), fits.Column(name='dist', format='D', array=pc), fits.Column(name='distmod', format='D', array=distmod), fits.Column(name='MG', format='D', array=Mg), fits.Column(name='ebv', format='D', array=ebv), fits.Column(name='parallax_hogg', format='D', array=parallax)])

    endtable = fits.BinTableHDU.from_columns(cols)
    endtable.writeto('../galexplane_gaia_dust_interp.fits')
